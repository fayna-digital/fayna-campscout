...
| Orphans | вимоги без тесту + тести без вимоги | цей луп (фаза trace) | на кожен реліз | зараз: 0+11; ціль 0 |
| Verification-method coverage | % вимог із зазначеним методом | фаза per-req цього лупа | щоміс | зараз: 69%; ціль 100% |
| Вимірність | % вимог із числами/порогами | фаза per-req | щоміс | зараз: 67%; ціль ≥90% |
